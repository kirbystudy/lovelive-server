...
(
    `id`           VARCHAR(32)                 NOT NULL PRIMARY KEY COMMENT '歌单ID',
    ...
    CONSTRAINT `c_cover_id` FOREIGN KEY (`cover_id`) REFERENCES `file` (`id`),
    CONSTRAINT `c_creator_id` FOREIGN KEY (`creator_id`) REFERENCES `user` (`id`)
) ENGINE = InnoDB
